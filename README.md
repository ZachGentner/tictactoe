...
<h3 align="center">Tic-Tac-Toe</h3>
  ...
  <p align="center">
    A simple, two-player, tic-tac-toe game made using vanilla JavaScript.
    <br />
    ...
    ·
    <a href="https://github.com/zachgentner/tictactoe/issues">Request Feature</a>
  </p>
</div>
...
[![Product Name Screen Shot][product-screenshot]](https://www.zachgentner.com/img/tictactoe.png)

This project was part of The Odin Project's Full Stack JavaScript course. Throughout my studies and during development, I learned about building game logic, creating game state, and how to create objects using functions, factories, and modules. This alsoserved as a refresher on navigating and manipulating the DOM.
...
None! This project can be experienced via the live demo or downloaded locally by following the instructions below.

### Installation

1. Clone the repo
   ```sh
   git clone https://github.com/zachgentner/tictactoe.git
   ```
...
This game is meant to be played on a single device with two players. The players will alternate taking turns placing their tokens until a winner has been determined or a tie has occurred.
...
- [ ] Add an AI model to play against in single player mode.
- [ ] Add the ability for players to specify their names.
- [ ] Add special tokens for the players to choose before playing.
...
Project Link: [https://github.com/zachgentner/tictactoe](https://github.com/zachgentner/tictactoe)
